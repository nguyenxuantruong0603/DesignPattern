...
public class LxVoDoi extends Observer {
    public LxVoDoi(SubjectObserver subjectObserver) {
    ...
    public void payWage() {
        if (subjectObserver instanceof Wage) {
            ...
            Log.e("Lương LxVoDoi", "Lương cơ bản: " + wage.getDefaultWage() + " | Thưởng thêm: " + wage.getThuongThem());
        }
    }

    @Override
    public void notifyWageChange(Integer wage) {
        Log.e("Lương Mới LxVodoi", String.valueOf(wage));
    }
}
